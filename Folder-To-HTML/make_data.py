...
class DataView:
    def __init__(self, data_folder, html_file):
        ...
        self.all_tags = set()
        self.objects = {".mp4": [], ".mp3": [], ".pdf": [], "other": []}
        ...
        self.data_types = {
            ...
            ".mp3": """
                    ...
                    """,
            ".pdf": """
                    <a class="td-pdf" href="file://"""
            + data_dir_path
            + """/{src_info}" target="_blank" >OPEN</a>
                    """,
        }
        self.list_of_files = {}
    ...
    def write_middle_html(self, object):
        ...
        with open(self.html_file, "a") as h_file:
            h_file.write(
                ...
                """.format(
                    src_info=self.data_types[ext].format(src_info=src_info),
                    src_name=src_name,
                    src_tags=src_tags,
                )
            )
    ...
    def write_end_html(self):
        with open(self.html_file, "a") as h_file:
            h_file.write(
                ...
                <script src=" """
                + static_folder
                + """/js/outside/jquery-3.6.1.min.js"></script>

                <!-- ALL MAIN SCRIPTS-->
                <script src=" """
                + static_folder
                + """/js/main/data_view.js"></script>
                </body>
                </html>
                """
            )
    ...
    def work_on_files(self):
        ...
        src_tags = "\n".join(
            '<div class="_td-te">#{}</div>'.format(t) for t in list(self.all_tags)
        )
